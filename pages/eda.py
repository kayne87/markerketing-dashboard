...
gdf = gpd.read_file(path + 'limits_IT_regions.geojson')
gdf = gdf.reset_index()
...
df_orders_age = df_customers_orders[df_customers_orders["age"] >= 20][["age", "gross_price"]].groupby(by=["age"]).mean().reset_index()
    ...
    [
        ...
        html.Div(children=
            [
                ...
                html.Div(children=
                    [
                        html.P('Avg revenue by age', style={'font-weight': 'bold'}),
                        dcc.Graph(
                            ...
                            figure=px.bar(
                                ...
                                x='AGE+',
                                y='gross_price'
                                ,text=df_orders_age['gross_price'].apply(format_two_decimals)
        ...
        html.Div(children=
            [
                ...
                html.Div(children=
                    [
                        html.P('Revenue vs Quarters (four-months period)', style={'font-weight': 'bold'}),
                        dcc.Graph(
